      ...
      {() => (
        <Form className="max-w-md mx-auto p-4 bg-white shadow-md rounded-md">
          ...
          <div>
            ...
            <Field type="text" name="username" className="w-full mt-1 border rounded-md p-2" />
          ...
          <div>
            ...
            <Field type="password" name="password" className="w-full mt-1 border rounded-md p-2" />
          ...
          <button type="submit" className="w-full mt-4 bg-blue-500 text-white font-semibold rounded-md p-2 hover:bg-blue-600">Register</button>
        </Form>
      )}
    </Formik>
  );
